...
import { exportBackup, importBackup, load, save } from './storage';
...
export default function App() {
  ...
  const t17 = totals(data.entries, todayIso());
          ...
          (() => {
            ...
            return (
              <CustomerView
                ...
                reminderHref={bal > 0 ? reminderLink(c.phone, c.name, bal, msg) : null}
              />
            );
          })()}
